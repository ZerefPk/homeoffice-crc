        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    RELATORIO DO DIA - PERIODO DA {{session('periodo')}}

                </div>
                <nav class="navbar">
                    <a class="btn btn-primary" href="{{route('home')}}"> <i class="fa fa-dashboard"></i>Dashboard</a>
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-success" role="alert">
                        "Você não possui PENDENCIAS para o dia. Seu Relatorio foi entregue!"
                    </div>
                    @endif
                    @if (session('success'))
                    <div class="alert alert-success" role="alert">
                        ...
                        <form action="{{route('storeRelatorio')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="file" multiple="multiple" value="{{old('anexos')}}" class="form-control" name="anexos[]">
                                </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <a href="{{route('downloadAnexo',$anexo->id)}}" class="btn btn-primary"> <i class="fa fa-download"></i> </a></td>
                                    <td>
